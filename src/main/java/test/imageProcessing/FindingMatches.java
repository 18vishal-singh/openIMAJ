...
/**
 * This class link the matches using {@link BasicMatcher} and
 * {@link RobustAffineTransformEstimator}
 *
 */
public class FindingMatches {
	public static void main(String args[]) throws IOException {
		MBFImage image1 = ImageUtilities.readMBF(new File("data/bird.jpg"));
		MBFImage image2 = ImageUtilities.readMBF(new File("data/bird2.jpg"));
