...
/**
 * This class basically extract the main frames from the provided video Main
 * frames are the frames which are present in video for longer time.
 * 
 * All frames of video will be saved in Output/frames. Main frames will be saved
 * in Output/mainframes.
 *
 */
